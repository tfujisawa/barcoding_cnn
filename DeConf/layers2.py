...
class DeConf(Layer):
    ...
    def score_hi(self, x): #X: outputs from the last layer in Tensor. Convert to numpy.array to use....
        return (
            tf.math.reduce_max(
    ...
    def score_g(self, x): #X: outputs from the last layer in Tensor. Convert to numpy.array to use....
        return (
            self._class_independent_component(x)
        )
